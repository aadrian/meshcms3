...
<p>
<%
  Configuration c = webApp.getConfiguration();
  
  c.setThemesDir(request.getParameter("themesPath"));
  c.setModuleTemplatesDir(request.getParameter("moduleTemplatesPath"));
  
  c.setVisualTypes(request.getParameter("visualTypes"));
  ...
  webApp.updateSiteMap(true); // needed to re-init the cache
