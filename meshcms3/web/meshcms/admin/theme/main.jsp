...
<%
  String themePath = request.getContextPath() + "/" +
      webApp.getAdminPath() + "/" + Finals.ADMIN_THEME;
%>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="white">
 ...
 <tr>
  <td bgcolor="#CCDC56" align="center">
   <a href="<%= request.getContextPath() + '/' + webApp.getAdminPath() %>/">MeshCMS</a>: <decorator:title default="" />
  </td>
 </tr>
...
%>
    ...
    System charset: <%= webApp.SYSTEM_CHARSET %> |
...
%>
    ...
    <%= webApp.VERSION_ID %> | Copyright &copy; 2004-2006 Luciano Vernaschi
