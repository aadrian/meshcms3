...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <c:set target="${mesh.files}" property="s1" value="${mesh.themePath}/style.css"/>
    <c:set target="${mesh.files}" property="s2" value="${mesh.meshPath}/lib/colorbox/colorbox.css"/>
    <c:set target="${mesh.files}" property="s3" value="${mesh.meshPath}/meshcms.css"/>
    <c:if test="${mesh.site.userCSS ne null}">
      <c:set target="${mesh.files}" property="s4" value="${mesh.site.userCSS}"/>
    </c:if>
    ...
    <c:set target="${mesh.files}" property="s1" value="${mesh.themePath}/script.js"/>
    <c:set target="${mesh.files}" property="s2" value="${mesh.meshPath}/lib/jquery-1.4.2.min.js"/>
    <c:set target="${mesh.files}" property="s3" value="${mesh.meshPath}/lib/colorbox/jquery.colorbox-1.3.6-min.js"/>
