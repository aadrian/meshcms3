			...
			new Command() {
				public void execute() {
					...
					if (selectedFile == null) {
						...
						new AuthorizableServerCall<Triple<String, String, String>>() {
								@Override
								...
								@Override
								public void onResult(Triple<String, String, String> result) {
									new CodeEditor(result.getFirstObject(),
										result.getSecondObject(), result.getThirdObject(),
										new Task<String>() {
			...
			new Command() {
				public void execute() {
					...
					if (selectedFiles.size() == 0) {
						...
						fields.setActionButton(inputBox.getButton(0));
						fields.verifyAll();
						inputBox.showDialog(new Task<Integer>() {
								public void execute(Integer buttonIndex) {
									fields.storeAll();
