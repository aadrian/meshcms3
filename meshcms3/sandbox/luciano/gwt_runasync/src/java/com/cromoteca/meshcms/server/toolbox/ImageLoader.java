 ...
 * package creates some performance problems with JPEG files that contain color
 * profile information. This class works fine in a headless environment.
 */
public class ImageLoader implements ImageConsumer {
	...
	public Image getImage() {
		...
		return Toolkit.getDefaultToolkit()
				.createImage(new MemoryImageSource(width, height, imgPixels, 0, width));
	}
