...
public class Context extends com.cromoteca.meshcms.server.webview.Context {
	...
	public static ResourceBundle getConstants() {
		return getBundle("com.cromoteca.meshcms.client.i18n.Constants");
	}

	public static ResourceBundle getMessages() {
		return getBundle("com.cromoteca.meshcms.client.i18n.Messages");
	}

	private static ResourceBundle getBundle(String name) {
		ResourceBundle bundle = Context.getScopedAttribute(name,
				ResourceBundle.class, Scope.REQUEST);

		if (bundle == null) {
			bundle = ResourceBundle.getBundle(name, getLocale());
			Context.setScopedAttribute(name, bundle, Scope.REQUEST);
		}
