 ...
 */
public final class MeshCMSFilter implements Filter, Finals {
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if (filterConfig != null && (request instanceof HttpServletRequest)) {
      ...
      if (webSite.getCMSPath() != null) {
        ...
        boolean isAdminPage = pagePath.isContainedIn(webSite.getAdminPath());
        ...
        if (FileTypes.isPage(pagePath)) {
          ...
          if (themePath != null) {
            themePath = (Path) webSite.getSiteMap().getThemesMap().get(themeParameter);
          }
          ...
          if (themePath != null) { // there is a theme for this page
            ...
            if (!isAdminPage) {
              request.setAttribute(THEME_FILE_ATTRIBUTE, "/" +
                  webSite.getServedPath(themePath) + "/" + THEME_DECORATOR);
            }
          }
        ...
        if (pageInfo != null) { // this page is contained in the site map
          ...
          if (isGuest && Utils.isNullOrEmpty(httpReq.getQueryString()) &&
            ...
            File cacheFile = webSite.getRepositoryFile(pagePath, CACHE_FILE_NAME);
            InputStream in = null;
          ...
          if (isAdminPage) {
            if (pagePath.getLastElement().endsWith(".js") &&
