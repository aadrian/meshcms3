...
public interface Finals {
   ...
   */
  public static final String USERS_SUBDIRECTORY = "private/users";
  
  /**
   * Path of the file that contains site preferences.
   */
  public static final String CONFIG_FILE = "private/configuration.xml";

  public static final String SITES_FILE = "private/sites.xml";

  /**
   * Path for the menu configuration file.
   */
  public static final String PROPERTIES_FILE = "private/siteprops.xml";

  /**
   * Path of the repository (contains backups and thumbnails)
   */
  public static final String REPOSITORY_SUBDIRECTORY = "private/repository";
  
  public static final String OTHER_SITES_SUBDIRECTORY = "private/sites";

  public static final String OTHER_SITES_ID_FILE =
      "private/sites/meshcms_multisite_id";
  ...
  public static final String BLOCK_CACHE_ATTR = "MeshCMS-No-Cache-Please";
