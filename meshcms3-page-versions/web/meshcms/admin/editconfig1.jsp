...
<form action="editconfig2.jsp" method="post">
  ...
  <fieldset class="meshcmseditor">
    ...
    <div class="meshcmscheckbox">
      <input type="checkbox" id="enableSaveAsDraft" name="enableSaveAsDraft"
       value="true"<%= configuration.isEnableSaveAsDraft() ? " checked='checked'" : "" %> />
      <label for="enableSaveAsDraft"><fmt:message key="configEnableSaveAsDraft" /></label>
    </div>

    <div class="meshcmscheckbox">
      <input type="checkbox" id="enableHiddenPaths" name="enableHiddenPaths"
       value="true"<%= configuration.isEnableHiddenPaths() ? " checked='checked'" : "" %> />
      <label for="enableHiddenPaths"><fmt:message key="configEnableHiddenPaths" /></label>
    </div>
  </fieldset>
