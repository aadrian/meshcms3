...
public class Configuration implements Serializable {
  ...
  private boolean enableHiddenPaths;
  ...
  private Configuration() {
    ...
    setEnableSaveAsDraft(false);
    setEnableHiddenPaths(false);
   ...
   */
	...
	/**
   * Returns the state of draft functionality.
   */
  public boolean isEnableSaveAsDraft() {
    return enableSaveAsDraft;
  }

  /**
   * Enables or disables save as draft functionality.
   */
  public void setEnableSaveAsDraft(boolean enableSaveAsDraft) {
    this.enableSaveAsDraft = enableSaveAsDraft;
  }

  /**
   * Returns state of the hidden page and path functionioality. 
   */
	public boolean isEnableHiddenPaths() {
		return enableHiddenPaths;
	}

	/**
	 * Enables or disables the hidden page and path functionioality. 
	 */
	public void setEnableHiddenPaths(boolean enableHiddenPaths) {
		this.enableHiddenPaths = enableHiddenPaths;
	}
}
